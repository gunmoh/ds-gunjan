...
select count(token) as total_tvs, sum(match_male) as male_matched , sum(match_female) as match_female
from (
select *, case when demo_male_1 = demo_male_2 then 1 else 0 end as match_male ,
       case when demo_female_1 = demo_female_2 then 1 else 0 end as match_female

from (
select tvid, token, (demo_male_18_24 +  demo_male_25_34 + demo_male_35_44 +demo_male_45_54 +demo_male_55_64 + demo_male_65_999)  as demo_male_1,
       (demo_male_18_29 + demo_male_30_39 + demo_male_40_49 +demo_male_50_59 +demo_male_60_69 +demo_male_70_999) as demo_male_2,
       (demo_female_18_24 +  demo_female_25_34 + demo_female_35_44 +demo_female_45_54 +demo_female_55_64 + demo_female_65_999)  as demo_female_1,
       (demo_female_18_29 + demo_female_30_39 + demo_female_40_49 +demo_female_50_59 +demo_female_60_69 +demo_female_70_999) as demo_female_2

from gunjanmohan.agedemo_bucket) a) b



select max(match_date) from detection.experian_demography_historical
         --where match_date = '2023-04-15 00:00:00.000000'
         order by 1
limit 20
...
select * from  gunjanmohan.agedemo_bucket limit 10
